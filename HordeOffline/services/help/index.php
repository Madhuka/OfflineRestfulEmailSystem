...
include "Horde/String.php";
include "Horde/Util.php";
include "Horde/Tree.php";
...
$sidebar_url ='index.php?Horde=qbi3pah0uu07sb7pc8l9u40sc2&show=sidebar&module=imp&topic=overview';

$help_app = 'Mail';
$fileroot = '';
$help_file = "helpfiles/help.xml";
$help_file_fallback = 'helpfiles/help.xml';
...
if ($show == 'sidebar') {
   ...
   // $tabs->addTab(_("Sea_rch"), $sidebar_url, 'search');
    ...
    require 'templates/help/sidebar.inc';
} else {
    $help = new Help(HELP_SOURCE_FILE, array($help_file, $help_file_fallback));
    if (($show == 'entry') && $topic) {
        $help->lookup($topic);
